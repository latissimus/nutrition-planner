// Open Food Facts für verpackte Markenprodukte (Suche + Barcode). Deutsche
// Grundnahrungsmittel liefert der Client lokal aus dem Bundeslebensmittel-
// schlüssel (BLS); diese Function kümmert sich nur noch um OFF.
const corsHeaders = {
