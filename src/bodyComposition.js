...
export const BODY_EXPLANATIONS = Object.freeze({
  ...
  skinfolds: 'Die Falten-Summe (Kinn bis Wade) ist ein Verlaufswert für das Unterhautfett. Sie ist keine direkte Messung des Körperfettanteils. Vergleiche sind nur sinnvoll, wenn die Messungen unter ähnlichen Bedingungen durchgeführt werden.',
...
export function evaluateBodyComp({ weight, skinfoldDelta = null, waistDelta = null, performanceTrend = null, recoveryTrend = null, weeks = 0 }) {
  ...
  const base = {
    ...
    limitations: [
      ...
      'Die Falten-Summe erfasst überwiegend Unterhautfett und nicht das gesamte Körperfett.',
