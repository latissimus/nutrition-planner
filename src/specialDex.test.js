...
describe('Special-Dex-Vorlage', () => {
  ...
  it('schließt ein gemeinsames Overlay per Schließen-Aktion und Escape', () => {
    ...
    expect(backdrop.style.setProperty).toHaveBeenCalledWith('--ordner', '#5C0702');
    expect(backdrop.style.setProperty).toHaveBeenCalledWith('--ordner-ink', '#FFA175');
    expect(backdrop.style.setProperty).toHaveBeenCalledWith('--dex-seitenfarbe', '#FFA175');
    expect(backdrop.style.setProperty).toHaveBeenCalledWith('--dex-ink', '#5C0702');
