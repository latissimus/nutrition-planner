...
async function loadEntry(userId, id, signal) {
  ...
  const rootNames = { home: 'Meine Dex-Einträge', 'food-log': 'COOKNOTES', training: 'TRAINNOTES', reminders: 'MEALS', body: 'BODYLOG', habits: 'ROUTINES', sleep: 'SLEEPLOG', stress: 'STRESSNOTES' };
