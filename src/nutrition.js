...
function calculatorMarkup(state, result) {
  ...
  return `<p class="nutrition-calc-note">${BODY_EXPLANATIONS.initialCalories}</p>
    <div class="nutrition-calc-grid">
      ...
      <label><span>Gewicht</span><span class="nutrition-unit-field"><input class="input" type="text" inputmode="decimal" data-calc-weight value="${state.latestWeight || ''}" placeholder="80"><i>kg</i></span><small>Wird auch im BODYLOG gespeichert.</small></label>
