  ...
  if (!recipes.length) {
    return `<details class="reminder-group einkauf-rezepte">
      <summary class="reminder-group-head">
        ...
        <span><b>Rezepte aus REZEPTE</b></span>
        <span class="reminder-group-chevron" aria-hidden="true">${materialIconMarkup('chevron_right')}</span>
      </summary>
      <div class="reminder-group-list einkauf-rezepte-leer">Noch keine Rezepte auf der Seite REZEPTE. Lege dort ein eigenes Rezept oder einen Rezeptlink an, dann erscheint es hier.</div>
    </details>`;
  }
  return `<details class="reminder-group einkauf-rezepte">
    <summary class="reminder-group-head">
