...
const defaults = {
  ...
  recipes: 'menu_book', essen: 'emoji:🍽️', training: 'fitness_center', supps: 'medication', habits: 'bucket_check',
  shopping: 'emoji:🛒',
  sleep: 'emoji:😴',
  stress: 'emoji:⚡',
  coins: 'star',
...
const defaultColors = {
  ...
  recipes: '#F0C987', essen: '#3C153B', training: '#013E37', supps: '#47230F', habits: '#4B125C',
  shopping: '#FFEDE3',
  sleep: '#0E1D47',
  stress: '#E36887',
  coins: '#E6D6FF',
