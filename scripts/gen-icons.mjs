...
for (const name of ['icon.svg', 'app-icon.svg', 'muscledex-app-icon-v4.svg']) {
...
for (const size of [192, 512]) {
  ...
  await writeFile(new URL(`../public/muscledex-icon-${size}-v4.png`, import.meta.url), png);
}
...
await writeFile(new URL('../public/muscledex-apple-touch-icon-v4.png', import.meta.url), apple);
