...
const iconSvg = await readFile(new URL('../CAPCOINSYMBOL.svg', import.meta.url), 'utf8');

await writeFile(new URL('../public/capboy-app-icon-v10.svg', import.meta.url), iconSvg);
for (const [name, size] of [
  ['capboy-icon-192-v10.png', 192],
  ['capboy-icon-512-v10.png', 512],
  ['capboy-apple-touch-icon-v10.png', 180],
